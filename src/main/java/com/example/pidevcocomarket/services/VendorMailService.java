...
public class VendorMailService {
    ...
    public void sendQuantityLowEmail( String vendorMail) {
        ...
        String bodyContinue = "\nOr you can add a promotion to your remaining products  by clicking at the link below to start a promotion\n ";
        String promotionLink = "http://localhost:8075/swagger-ui/index.html#/promotion-rest-controller/addPromotionToStock";

        body = body + tenderLink + bodyContinue + promotionLink;

        /*SimpleMailMessage message = new SimpleMailMessage();
        message.setFrom("chebbi.mohamed1@esprit.tn");
